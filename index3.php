    ...
    <body>
        <div class="container">
			<div class="codrops-top">
				  ...
				  <a href="video/index.html" title="Video">Video</a>
				  <a href="about/" title="About Pikachoo">About</a>
				  <a href="shop/index.php" title="Shop Online">Shop</a>
				  ...
				  <?php
					if(!isset($_SESSION['s_var']))
					{
						echo '<span class="right">
								<a href="login/index.php" class="codrops-demos" title="Login / Register">
			...
			<section class="main">
				...
				<ul class="ch-grid">
					<li>
						<img src="logo/logo1_1.jpg" alt="pikachoo">
					</li>
					<li>					
						<div class="ch-item">	
							<div class="ch-info">
								<h3>Gifts</h3>
								<p>Gift Items & Funky Bags<a href="shop/index.php">Shop Online</a></p>
							</div>
					...
					<li>
						<div class="ch-item">
							<div class="ch-info">
								<h3>Cakes</h3>
								<p>Cupcakes, Pies & Puddings<a href="shop/index.php">Shop Online</a></p>
							</div>
					...
					<li>
						<div class="ch-item">
							<div class="ch-info">
								<h3>Florist</h3>
								<p>Natural & Artificial Flowers<a href="shop/index.php">Shop Online</a></p>
							</div>
