...
<!DOCTYPE html>
 <html lang="en" class="no-js">
    ...
    <body>
		...
		<center>
		<table width="600">
		<tr><th><h2><a href="pass.php">Change Password</a></h2></td><td><h2><a href="track.php">Track My Order</a></h2></td><td><h2><a href="order.php">MyOrder</a></h2></td></tr></table>
		<hr color="white">
		<br><br>
		<?php
