...
<html>
 <head>
  <title>Change Password | Pikachoo</title>
...
<center>
		<table width="600">
		<tr><th><h2><a href="profile.php">View Profile</a></h2></td><td><h2><a href="track.php">Track My Order</a></h2></td><td><h2><a href="order.php">MyOrder</a></h2></td></tr></table>
		<hr color="white">
		<br><br>
		<table width="400">
		<form action="" method="POST">
		
			<font face="comic sans ms"><h2><u>Change Password</u></h2></font><br><br><br>
			<tr><td><font color="blue"><b>Enter Your Old Password:</b></font></td><td><input type="password" required name="pass1"></td></tr>
			<tr><td><font color="blue"><b>Enter Your New Password:</b></font></td><td><input type="password" required name="pass2"></td></tr>
			<tr><td><font color="blue"><b>Confirm Your Password:</b></font></td><td><input type="password" required name="pass3"></td></tr>
			</table>
			<br><br>
...
if(isset($_POST['submit']))
{
	...
	$str="select * from samkush_login where userid='$k'";
	echo $p1;
	echo $p2;
	echo $p3;
	...
	if($p2!=$p3)
	 echo "<font color='red' face='comic sans ms'>Passwords Do Not Match!!! Try Again..!! </font>";
	else if($p1!=$row[3])
	 echo "<font color='red' face='comic sans ms'>Incorrect Password!!! Try Again..!! </font>";
	else 
	 {
	  $str1="update samkush_login set password='$p2' where userid='$k'";
	  mysqli_query($con,$str1);
	  
	  echo $str1;
	  echo "<font color='red' face='comic sans ms'>Password Successfully Changed..!! </font>";
