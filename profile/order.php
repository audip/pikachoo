...
<center>
		<table width="600">
		<tr><th><h2><a href="pass.php">Change Password</a></h2></td><td><h2><a href="track.php">Track My Order</a></h2></td><td><h2><a href="profile.php">View Profile</a></h2></td></tr></table>
		<hr color="white">
		<br><br>
		
			<font face="comic sans ms" color="red"><h2><u>MY ORDERS</u></h2></font><br><br>
			
<?php

    require "samkush.php";		
	$str="select * from samkush_order where userid='$uid'";
	
	echo '<center>';
	echo '<br><br>';
	
	$res=mysqli_query($con,$str);
	echo '<table border="2" width="600" height="200">
			<tr align="center"><font color="green">
				<th>Order No</th><th>Item Id</th><th>Item Name</th><th>Quantity</th><th>Price</th></font>
			</tr>';
	while($row=mysqli_fetch_array($res))
    {
 	echo 
			'<tr align="center">
				<td>'.$row[0].'</td><td>'.$row[2].'</td><td>'.$row[3].'</td><td>'.$row[4].'</td><td>'.$row[5].'</td>
			</tr>';
	}
