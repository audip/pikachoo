    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>This <b>shagun envelope</b> is made of <b>Chart Paper</b>.The highlight of the product is its stylish design along with a beautiful <b>Stone</b> lace at the end.It is ideal for gifting at festivities like <b>Diwali and Wedding</b>. <h3><u>Set of 6 pieces in 1 pack.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
...
<!DOCTYPE html>
 <html lang="en" class="no-js">
    <head>
        <meta charset="UTF-8" />
        <!-- <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">  -->
        <title>Pikachoo | Blue Chinese Fan Envelope 2</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
