...
?>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Envelope,Dupioni Envelope,Dupioni,Silk,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Dupioni Silk Envelope | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>It is made up of high end <b>Silk Dupioni</b> in the <b>Colour</b> and <b>Brooch</b> of your choice.<br>
