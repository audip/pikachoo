...
Testers.">
        <title>Velvet-Kundan-Envelope-2 | Pikachoo</title>
  ...
  <link rel="stylesheet" href="/resources/demos/style.css">
    ...
    <body>
		...
		<?php
			...
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_bags where item_id='40011'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
