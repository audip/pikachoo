...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Bags,Envelopes,Potli,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
		...
		<title>Envelopes | Pikachoo</title>
    </head>
    <body>
        <div class="container">			
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_bags where item_type2='envelope'";
			$result=mysqli_query($con,$str);
