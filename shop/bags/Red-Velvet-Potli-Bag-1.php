...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Potli Bags,Velvet Potli,Red Velvet Potli Bags,Potli,Kundan,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
store,Samip Jain,Kaushal Bajaj" />
        <meta name="author" content="Kaushal Bajaj & Samip Jain" <?php
	ob_start();
	session_start();
	require "samkush.php";
?>
...
Testers.">
        <title>Red-Velvet-Potli-Bag-1 | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>If there is a material that feels right for this season, it is the absolutely on-trend <b>VELVET</b>! The highlight of this product is <b>Beautiful Lace</b> along with a <b>Zipper Compartment</b> at the back.<br>Opulent without being over the top, this <b> Potli Bag</b> is all you need to stand out in a bling drenched crowd.
</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Be ready to dazzle the crowd by carrying this golden beaded<b>Red Velvet Potli Bag</b>.Beaded round handle and a single <b>zipper</b>compartment completes the look of this potli bag.<br>Wear it with your favourite dress when you are out partying with friends.
</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
