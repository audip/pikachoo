...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Envelope,Jamawar Envelope,Jamawar,Brocade,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Jamawar Envelope-1 | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>The <b>BROCADE ( JAMAWAR )</b> enhances the traditional look of this envelope.It has a button closure at the back.<br> It has variants available in other <b>COLOURS</b> as well.<br>
