...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Bags,Potli Bags,Envelopes,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
		...
		<title>Potli Bags | Pikachoo</title>
    </head>
    <body>
        <div class="container">			
		...
		<nav id="nav">
		 <div class="container1">
			...
			<li>
				...
				<ul class="span2">
					<li>
                         <a href="#" class="title">Envelope</a>                    </li>
					<li>
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_bags where item_type2='potli'";
			$result=mysqli_query($con,$str);
