...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="flower,bouquets,Laddo Gopal Antique Bouquet,Pikachoo,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Laddo Gopal Antique Bouquet | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>So <b><i>Fluffy</i></b>, so <b><i>Soft</i></b>, Spiked with <b><i>Vanilla</i></b>, & bursting through the seems with colourful speckles.<br>
These <b>CUPCAKES</b> are to die for.<h3><u>Set of 6 pieces in 1 pack.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
