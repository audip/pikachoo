...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="flower,bouquets,White Carnition With BOP Flowers,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>White Carnition With BOP Flowers | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>A perfect combination of <b>White Carnition and BOP Flowers </b> makes a perfect bouquet for any occassion</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
