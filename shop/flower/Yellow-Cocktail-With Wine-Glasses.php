...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="flower,bouquets,Yellow Cocktail With Wine Glasses,Pikachoo,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Yellow Cocktail With Wine Glasses | Pikachoo</title>
  ...
  <link rel="stylesheet" href="/resources/demos/style.css">
    ...
    <body>
		...
		<?php
			...
			$item_id=$_GET['id'];
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_flower where item_id='$item_id'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
			//echo $str;
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Surprise that special someone who makes you smile with our stunning Artificial Bouquet.<br> This elegant arrangement of <b>Yellow Cocktail, 2 Wine glasses & Red Flowers </b>is a truly thoughtful gift for birthdays, anniversaries or just to show how much you care.<b>Order today</b>. </td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
		...
		<li>Flowers might arrive in bud/Semi bloom/fully bloom condition as per local availability at the time of delivery</li>
		...
		<li>For further details please visit FAQs.</li>
		</ol>';		
		?>
