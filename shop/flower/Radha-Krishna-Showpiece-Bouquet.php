...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="flower,bouquets,Radha Krishna Showpiece Bouquet,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Radha Krishna Showpiece Bouquet | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Spread boundless love everywhere with this beautiful Bouquet as <b>Radha-Krishna</b> is a symbol of pure love, care and affection. </td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
