...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="flower,bouquets,Happy Birthday Baby Girl,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Happy Birthday Baby Girl | Pikachoo</title>
  ...
  <link rel="stylesheet" href="/resources/demos/style.css">
    ...
    <body>
		...
		<?php
			...
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_flower where item_id='20016'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
			//echo $str;
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Bang, go the flowers! This vigorous colorful Bouquet includes <b>Pink Carnitions, Pink soft toys </b> . Its a enjoyable, excellent pick for your beloved girly girl! on her 1st Bday.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
