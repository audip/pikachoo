...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="flower,bouquets,Radium Radha Krishna Bouquet,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Radium Radha Krishna Bouquet | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Spread boundless love everywhere with this beautiful <b>Radium Radha-Krishna</b> Bouquet.<br>The Red artificial Rose fillers are a add-on to the Beautiful and exotic floral arrangement.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
