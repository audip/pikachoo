...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Bouquets,artificial flowers,natural flowers,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
		...
		<title>Artificial Bouquets | Pikachoo</title>
    </head>
    <body>
        <div class="container">			
		...
		<nav id="nav">
		 <div class="container1">
			...
			<li>
				...
				<ul class="span2">
					<li>
                         <a href="natural.php" class="title">Natural Bouquet</a>                    </li>
					<li>
                        <a href="#" class="title">Artificial Bouquet</a>                    </li>
                </ul>
			</li>
	...
	<table align="center">
                    ...
                    <ul>
                        <li>
                            <a href="flower.php" class="title">Bouquets</a>
                                <ul>
                                    <li>
                                        <a href="natural.php" class="title">Natural Bouquets</a>
                                    </li>
                                    <li>
                                        <a href="#" class="title">Artificial Bouquets</a>
                                    </li>
                                </ul>
                        </li>
					</ul>
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_flower where item_type2='artificial'";
			$result=mysqli_query($con,$str);
