...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Bouquets,natural flowers,rose,red rose,natural,artificial flowers,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
		...
		<title>Natural Bouquets | Pikachoo</title>
    </head>
    <body>
        <div class="container">			
		...
		<nav id="nav">
		 <div class="container1">
			...
			<li>
                <a href="flower.php" class="title">Bouquet</a>       
				<ul class="span2">
					<li>
                         <a href="#" class="title">Natural Bouquet</a>                    </li>
					<li>
                        <a href="artificial.php" class="title">Artificial Bouquet</a>                    </li>
                </ul>
			</li>
	...
	<table align="center">
		...
		<div class="span3">
			<div class="widget Categories">
                <h3 class="widget-title widget-title">Categories</h3>
                    <ul>
                        <li>
                            <a href="flower.php" class="title">Bouquets</a>
                                <ul>
                                    <li>
                                        <a href="#" class="title">Natural Bouquets</a>
                                    </li>
                                    <li>
                                        <a href="artificial.php" class="title">Artificial Bouquets</a>
                                    </li>
                                </ul>
                        </li>
					</ul>
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_flower where item_type2='natural'";
			$result=mysqli_query($con,$str);
