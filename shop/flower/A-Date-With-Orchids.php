...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="FLower,Orchids,A Date With Orchids,Bouquets,Pikachoo,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>A Date With Orchids | Pikachoo</title>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				<tr>
					...
					<td>&nbsp;</td>
					<td align="center" height="70"><h1>Price:'.$row[0].'</h1></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Make their day a trip to the tropics with our exotic bouquet of long-lasting,<b>Purple Orchids</b>.<br>
					Decorated with <b>Yellow Rose</b> and Decorative Items, This bouquet gives a special ethnic look that are soothing to your eyes.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
