...
Testers.">
    ...
    <body>
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_flower";
			$result=mysqli_query($con,$str);
