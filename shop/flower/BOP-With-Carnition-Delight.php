...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Flower,Carnition,Rose,Bouquets,BOP With Carnition Delight,Pikachoo,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift.
...
Testers.">
        <title>BOP With Carnition Delight | Pikachoo</title>
  ...
  <link rel="stylesheet" href="/resources/demos/style.css">
    ...
    <body>
		...
		<?php
			...
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_flower where item_id='20010'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
			//echo $str;
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Charming mixed arrangement of <b>BOP Flowers along with Yellow Carnitions</b> with a tinge of Gaddy and Dry Items.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
