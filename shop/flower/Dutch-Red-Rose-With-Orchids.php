...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Flower,Bouquets,Rose,Orchids,Dutch Red Rose With Orchids,Pikachoo,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Dutch Red Rose With Orchids | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>We present you this lovely classic bouquet of <b>Dutch Roses & Orchids </b decorated with dry items which bring out the colours of the roses.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
