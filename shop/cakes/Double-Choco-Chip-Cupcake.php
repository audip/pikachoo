...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Double Choco Chip Cupcakes,Cupcakes,Puddings,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Double Choco Chip Cupcake | Pikachoo</title>
...
<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>These delectable <b>Double-Chocolate-Chip-Cupcakes</b> are absolutely <b><i>Mouthwatering</i></b>;<br>
When their sweet <b>Aroma</b> fills the room.<br> Dont be surprised to find yourself <b>Drooling</b>..!!<h3><u>Set of 6 pieces in 1 set.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
