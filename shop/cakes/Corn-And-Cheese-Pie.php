...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Corn And Cheese Pie,Pies,Puddings,Cupcakes,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Corn And Cheese Pie | Pikachoo</title>
...
<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p><b><i>Cheesy corn</b></i> filled pie is exactly what you need to brighten your day..!!</p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
