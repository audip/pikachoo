...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Cakes,Pies,Chocolates,Puddings,Cupcakes,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
    ...
    <body>
		 ...
		 <div class="container1">
			...
			<li>
				...
				<ul class="span2">
					...
					<li>
                        <a href="#" class="title">Pies &amp; Chocolates</a>                    </li>
				</ul>
			</li>
			<li>
                    ...
                    <ul>
                        <li>
                            <a href="cakes.php" class="title">Cakes</a>
                                <ul>
                                    <li>
                                        <a href="cupcakes.php" class="title">Cupcakes</a>
                                    </li>
                                    <li>
                                        <a href="puddings.php" class="title">Puddings</a>
                                    </li>
                                     <li>
                                        <a href="#" class="title">Pies &amp; Chocolates</a>
								      </li>
                                </ul>
                        </li>
					</ul>
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_cakes where item_type2='pies'";
			$result=mysqli_query($con,$str);
