...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Creamy Mushroom Pie,Pies,Puddings,Cupcakes,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Creamy Mushroom Pie | Pikachoo</title>
...
<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p><b><i>Mushroom pies</b></i> are the best <b><i>vegetarian pies!!!</b></i><br><br> Rich, hearty mushrooms cooked with a creamy sauce and encased in soft, melt in your mouth pastry,<b><i> so awesomely good.</b></i></p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
