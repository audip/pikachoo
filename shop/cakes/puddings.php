...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Cakes,Puddings,Pies,Chocolates,Cupcakes,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
		 ...
		 <div class="container1">
			...
			<li>
				...
				<ul class="span2">
					...
					<li>
                        <a href="#" class="title">Puddings</a>                    </li>
					<li>
	...
	<table align="center">
                        ...
                        <li>
                            <a href="cakes.php" class="title">Cakes</a>
                                <ul>
                                    ...
                                    <li>
                                        <a href="#" class="title">Puddings</a>
                                    </li>
                                     <li>
                                        <a href="pies.php" class="title">Pies &amp; Chocolates</a>
								      </li>
                                </ul>
                        </li>
					</ul>
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_cakes where item_type2='puddings'";
			$result=mysqli_query($con,$str);
