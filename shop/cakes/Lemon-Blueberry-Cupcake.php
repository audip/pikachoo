...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Lemon BLueberry Cupcakes,Cupcakes,Puddings,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Lemon Blueberry Cupcakes | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Fresh <b>Blueberry</b>cupcakes topped with <b><i>Lemon-Kissed-Cream frosting</i></b>. <br>A perfect
<b>Summer-Time</b> dessert! <h3><u>Set of 6 pieces in 1 set.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
