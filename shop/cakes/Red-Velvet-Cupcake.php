...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Red Velvet upcakes,Cupcakes,Puddings,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Red Velvet Cupcakes | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>This mini <b><i>Version</i></b> of the classic to die for <b><i>Red-Velvet-Cake</i></b>.<br>It is one of our most popular 
<b>Offerings</b>...so we suggest you get <b>ORDERING</b> as well.. ;)<h3><u>Set of 6 pieces in 1 set.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
