...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Cakes,Cupcakes,Puddings,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        ...
        <div class="container">			
		 ...
		 <div class="container1">
			...
			<li>
				...
				<ul class="span2">
					<li>
                         <a href="#" class="title">Cupcakes</a>                    </li>
					<li>
	...
	<!--<table align="center">
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_cakes where item_type2='cupcakes'";
			$result=mysqli_query($con,$str);
