...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Spinach Pie,Puddings,Cupcakes,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Spinach Pie | Pikachoo</title>
...
<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>This is an authentic, really <b><i>rich pie</b></i> stuffed with spinach, onions, cheese, herbs and 
exotic veggies...<br><br>These are all enfolded by <b><i>crispy flaky pastry pie..</b></i></p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
