...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Chocolate Fudge Puddings,Puddings,Cupcakes,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Chocolate Fudge Puddings | Pikachoo</title>
...
<?php
			...
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_cakes where item_id='30009'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
			//echo $str;
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>This sinful dessert is gonna take you straight to heaven.<br> This <b><i>ooey gooey</b></i> melt in the mouth
pudding cannot be missed out on.</p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
