...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Chocolava Cupcakes,Cupcakes,Puddings,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Chocolava Cupcakes | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Full of warm chocolate <b>Gooeyness</b>...<br>Everyones favourite Chocolate <b>SIN</b> has to be <b><i>ChocoLava
Cake</i></b>.<br>Totally irresistable..<b>yumm..</b>!!<h3><u>Set of 6 pieces in 1 set.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
