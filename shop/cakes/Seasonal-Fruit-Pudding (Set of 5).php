...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Seasonal Fruit Puddings,Puddings,Cupcakes,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Seasonal Fruit Puddings | Pikachoo</title>
...
<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>Layers of moist <b><i>vanilla cake ,fresh fruit, dollops of whipped cream,</b></i> hidden flavour of 
<b><i>cinnamon and crunchies...</b></i><br><br>If you have all of these in one dessert...<b>What more could you ask for????</b></p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
		...
		<li>Flavor may change according to the availablilty of FRUITS. </li>
