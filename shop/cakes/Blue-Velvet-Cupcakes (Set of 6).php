...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Blue Velvet Cupcakes,Cupcakes,Puddings,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Blue Velvet Cupcakes | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>A new twist on a traditional <b><i>Red-Velvet-Cake</i></b>,inspired by the <b>Royal Hierloom Sapphire</b>..<br>
This is one cupcake you cannot <b>MISS</b> out on.<h3><u>Set of 6 pieces in 1 set.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
