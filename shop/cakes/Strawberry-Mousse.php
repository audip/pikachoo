...
Testers.">
        <title>Chocolate Mousse | Pikachoo</title>
...
<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p><b><i>Smooth</b></i> and <b><i>creamy strawberry mousse</b></i> made with whipping cream, fresh strawberries,
lemon, gelatin...<br><br>You just gotta try this..!!</p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
