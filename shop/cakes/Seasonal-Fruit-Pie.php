...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Seasonal Fruit Pie,Puddings,Cupcakes,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Seasonal Fruit Pie | Pikachoo</title>
...
<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>Exactly the same as our wonderful apple pie but with the replacement of fresh seasonal fruits.</p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
