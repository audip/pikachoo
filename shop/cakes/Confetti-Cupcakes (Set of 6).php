...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Cakes,Confetti Cupcakes,Cupcakes,Puddings,Pies,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Confetti CupCakes | Pikachoo</title>
  ...
  $(function() {
    ...
    <body>
		...
		<?php
			...
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_cakes where item_id='30001'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
			//echo $str;
