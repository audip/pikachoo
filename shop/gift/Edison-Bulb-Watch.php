...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Edison Bulb Watch,Gifts,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gift store,Samip Jain,Kaushal Bajaj" />
...
Testers.">
        <title>Edison Bulb Watch | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>This Special Edison Bulb is a perfect Case for keeping your favourite watch.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
