...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Gifts,Multicolor Soft Ball,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Multicolor Soft Ball | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p><b><i>Soft</b></i> and colourful, Lightweight, <b><i>Washable,</b></i> Safe for Kids.</p><h3><u>Set of 3 balls in 1 pack.</u></h3></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
