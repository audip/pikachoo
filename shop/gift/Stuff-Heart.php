...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Stuff Heart,Gifts,Cakes,Cupcakes,Puddings,Pies,,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Stuff Heart | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>Soft to feel and touch, Excellent Gifting Option for any <b><i>occasion</b></i><br><br><h3><u>Set of 6 items in 1 pack</p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
