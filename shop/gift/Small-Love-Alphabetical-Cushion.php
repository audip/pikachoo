...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Small Love Alphabetical Cushion,Gifts,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gift store,Samip Jain,Kaushal Bajaj" />
...
Testers.">
        <title>Small Love Alphabetical Cushion | Pikachoo</title>
  ...
  $(function() {
    ...
    <body>
		...
		<?php
			...
			$item_id=$_GET['id'];
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_gift where item_id='$item_id'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
			//echo $str;
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>Practical and fun, this <b><i>folding funky school bus</b></i> is a perfect storage solution for any childs room!</p>The funky bus has ample storage space and is ideal for <b><i>storing toys, clothes</b></i> and other items to keep your kids <b><i>room neat and tidy.</b></i> Also, the bus easily folds up for when not in use.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
