...
<!DOCTYPE html>
 <html>
    <head>
        ...
        <meta name="keywords" content="Pikachoo,Pikachoo gifts,Gifts,gifts Items,bags,photoframe,showpiece,teddy,couple,Pikachoo,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
	...
	<table align="center">
		...
		<?php
			require "samkush.php";
			$str="select item_id,item_name,item_price,image from samkush_gift";
			$result=mysqli_query($con,$str);
