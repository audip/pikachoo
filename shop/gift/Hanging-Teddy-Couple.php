...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Hanging Teddy Couple,Gifts,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gift store,Samip Jain,Kaushal Bajaj" />
...
Testers.">
        <title>Hanging Teddy Couple | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>This Beautiful Hanging Teddy couple is perfect For gifting to your loved ones. </td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
