...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Blue Doremon Sharpner,Gifts,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gift store,Samip Jain,Kaushal Bajaj" />
...
Testers.">
        <title>Blue Doremon Sharpner | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Doraemon Pencil sharpening box is for standard graphite and colour pencils.<br>Includes built-in container to catch all the pencil shavings.Its a prefect gift for children.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
