...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Black & Red PhotoFrame,Gifts,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gift store,Samip Jain,Kaushal Bajaj" />
...
Testers.">
        <title>Black &amp; Red PhotoFrame | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>This Black And Red Photoframe is sure to bring that sweet smile on their face.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
