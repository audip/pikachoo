...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Hanging Bird,Gifts,Cakes,Cupcakes,Puddings,Pies,,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Hanging Bird | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>It is entirely <b>handmade,</b> It has <b><i>multicoloured beads,</b></i> small ghunghroo at the end, Excellent Gifting Option for any <b><i>occasion.</b></i> <br><br>(Different colour available)<br><br><h3><u>Set of 3 birds in 1 pack</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
