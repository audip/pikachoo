...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Heart Shaped Pearl PhotoFrame,Gifts,Cakes,Cupcakes,Puddings,Pies,,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
...
Testers.">
        <title>Heart Shaped Pearl PhotoFrame | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>Gorgeous vintage style pearl frame.<br><br>Beautiful metal heart shaped frames adorn with <b><i>Pearls</b></i> which is perfect to gift for your <b><i>loved ones.</b></i></p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
