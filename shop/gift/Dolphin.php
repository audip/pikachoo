...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Dolphin,Gifts,Cakes,Cupcakes,Puddings,Pies,,Pikachoo Store, Online Gift Store,gifts,flower,cupcakes,cakes,gift 
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2><p>Soft, Lightweight, Washable, Safe for Kids.</p>(Different colour available)<br><br><h3><u>Set of 5 dolphins in 1 pack</p></td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
