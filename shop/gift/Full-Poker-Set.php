...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Full Poker Set,Gifts,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,flower,Samip Jain,Kaushal Bajaj" />
...
Testers.">
        <title>Full Poker Set | Pikachoo</title>
    ...
    <body>
		...
		<?php
			...
			echo '<center><table width="900" height="400" border="0">
				...
				<tr>
					<td width="40">&nbsp;</td>
					<td><h2>Description</h2>Full Poker set for all card lovers.</td>
				</tr>
				<tr>
					<td width="40">&nbsp;</td>
