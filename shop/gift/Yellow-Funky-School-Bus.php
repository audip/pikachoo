...
<!DOCTYPE html>
 <html lang="en" class="no-js">
        ...
        <meta name="keywords" content="Pikachoo,Yellow Funky School Bus,Gifts,Cakes,Cupcakes,Puddings,Pies,Pikachoo Store, Online Gift Store,gift store,Samip Jain,Kaushal Bajaj" />
...
Testers.">
        <title>Yellow Funky School Bus | Pikachoo</title>
  ...
  $(function() {
    ...
    <body>
		...
		<?php
			...
			//echo $item_id;
			$str="select item_name,item_type,item_price,manu_name,image from samkush_gift where item_id='10015'";
			$result=mysqli_query($con,$str);
			$row=mysqli_fetch_array($result);
			//echo $str;
