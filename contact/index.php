...
<!DOCTYPE html>
 <html lang="en" class="no-js">
    <head>
		...
		<title>Pikachoo | Contact Details</title>
    </head>
    <body>
        <div class="container">		
		...
		<hr>
		<br>
		<br><br><h2><font color="blue">It will be our pleasure to receive any query from <b>YOU</b><br> Coz you are a customer and customer is more important than <b>chilled</b><b>beer</b>.</font></h2>
		<table height="400">
		...
		<tr align="center"><td><input type="text" size="30" required name="c3"></td></tr><br>
		<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;QUERY <sup>*</sup></td></tr>
		<tr align="center"><td><textarea rows="6" cols="30" name="c4"></textarea><br><font color="red"><p align="left"><sup>*</sup>Required Fields</p></font></td></tr><br>
		<tr align="center"><td><input type="submit" name="c5" value="DROP"></td></tr>
		</form>
		</table>
		<br><br><br>
<!--footer starts here-->					
